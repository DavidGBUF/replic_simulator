...
file_handler = logging.FileHandler(os.path.join(ROOT_DIR, "logs/inommus.log"))
...
class inommus:
    ...
    def __init__(self, model_name):
        ...
        self.model_path = f"rl_saved_models/{self.model_name}_inommus_allocation_model.zip"
        self.name = f"inommus{model_name}"
    ...
    def start_algorithm(self, env: SFC_AllocationEnv):
        ...
        # Garante que o ambiente está sincronizado com o grafo e SFC que o inommus recebeu.
